...
int printli(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printlu(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printlo(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printlx(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printlux(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printshi(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printshu(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printsho(va_list print_args, char *buf_ptr, unsigned int buf_index);
int printshx(va_list print_args, char *buf_ptr, unsigned int buf_index);
int prinshux(va_list print_args, char *buf_ptr, unsigned int buf_index);
